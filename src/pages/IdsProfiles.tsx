...
export default function IdsProfiles() {
    ...
    const createMut = useMutation({
        ...
        onSuccess: () => {
            qc.invalidateQueries({ queryKey: ["ids-profiles"] });
            setShowCreate(false);
            setName("");
            setRuleset("");
        },
    ...
    return (
        <div className="animate-fade-in">
            <PageHeader
                title={t("idsProfiles")}
                sub="// suricata ruleset configurations"
                actions={
                ...
                >
                    ...
                    <div className="flex gap-2">
                        <Btn
                            ...
                            disabled={!name || !ruleset || createMut.isPending}
                        >
                            {createMut.isPending
                                ? t("creating")
                                : t("createProfile")}
